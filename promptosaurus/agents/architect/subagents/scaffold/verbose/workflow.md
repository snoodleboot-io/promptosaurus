...
### Step 1: Ask these questions before generating anything — one at a time:

Detailed instructions for this step.

### Step 2: After all answers are collected:

Detailed instructions for this step.

### Step 3: Do not generate any code or files until the user has confirmed the plan.
