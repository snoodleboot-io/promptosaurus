...
### Step 1: Before suggesting fixes, gather context if not provided:

Detailed instructions for this step.

### Step 2: Ask for relevant artifacts if not provided:

Detailed instructions for this step.

### Step 3: Produce a ranked list of hypotheses for the root cause:

Detailed instructions for this step.

### Step 4: Do NOT jump straight to a fix — confirm the root cause first.

Detailed instructions for this step.

### Step 5: For intermittent bugs:
